;(function() {
  ...
  Ship.prototype.draw = function (ctx) {
    ...
    ctx.moveTo(this.pos[0] + ((Math.cos(60 * Math.PI/180) * this.radius)), this.pos[1] + (this.radius * Math.sin(60 * Math.PI/180)));
    ctx.lineTo(this.pos[0] + (Math.cos((60 - 150) * Math.PI/180) * this.radius), this.pos[1] + (this.radius * Math.sin((60 - 150) * Math.PI/180)));
    ctx.lineTo(this.pos[0] + (Math.cos((60 + 150) * Math.PI/180) * this.radius), this.pos[1] + (this.radius * Math.sin((60 + 150) * Math.PI/180)));
    // ctx.lineTo(this.pos[0] + (2 + 5), this.pos[1] - 17);
    // ctx.lineTo(this.pos[0] - ((Math.cos(0) * 17)), this.pos[1] + this.radius * Math.sin(0));
    // ctx.lineTo(this.pos[0] + ((Math.cos(30) * 17)), this.pos[1] + (this.radius * Math.sin(30));
    ctx.fill();
  };
