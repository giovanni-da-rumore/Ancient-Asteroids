;(function() {
  ...
  var LEVELS = ["Segesta", "Paestum", "Athens", "Agrigento", "Selinunte", "Taormina", "Delphi"];

  var Game = Asteroids.Game = function(width, height, highScore, state, numAsteroids) {
    this.backgroundFiles = [ "./images/segesta.jpg", "./images/paestum.jpg", "./images/acropolis.jpg", "./images/agrigento.jpg", "./images/selinunte.jpg",
  ...
  Game.prototype.addAsteroids = function() {
    if (this.state != "playing") {
     ...
     if (this.numAsteroids % 2 === 0) {
       var numAsteroids = this.numAsteroids / 2 + 1;
       var oddLevel = false;
    } else {
    ...
    while ( this.asteroids.length < numAsteroids) {
      ...
      if (testAsteroid.isCollidedWith(this.ship.forceField) && this.newLevel) {
        ...
        if (this.asteroids.length + 1 === numAsteroids && oddLevel == false) {
